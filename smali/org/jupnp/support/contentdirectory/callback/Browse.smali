.class public abstract Lorg/jupnp/support/contentdirectory/callback/Browse;
...
.field private static final DEFAULT_MAX_RESULT:I = 0x3e7
...
# direct methods
.method public constructor <init>(Lorg/jupnp/model/meta/Service;Ljava/lang/String;Lorg/jupnp/support/model/BrowseFlag;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "**>;",
            "Ljava/lang/String;",
            "Lorg/jupnp/support/model/BrowseFlag;",
            ")V"
        }
    .end annotation
    ...
    invoke-direct/range {v1 .. v9}, Lorg/jupnp/support/contentdirectory/callback/Browse;-><init>(Lorg/jupnp/model/meta/Service;Ljava/lang/String;Lorg/jupnp/support/model/BrowseFlag;Ljava/lang/String;JLjava/lang/Long;[Lorg/jupnp/support/model/SortCriterion;)V

    return-void
.end method

.method public varargs constructor <init>(Lorg/jupnp/model/meta/Service;Ljava/lang/String;Lorg/jupnp/support/model/BrowseFlag;Ljava/lang/String;JLjava/lang/Long;[Lorg/jupnp/support/model/SortCriterion;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 14
    .line 15
    const-class p1, Lorg/jupnp/support/contentdirectory/callback/Browse;
    ...
    .line 21
    iput-object p1, p0, Lorg/jupnp/support/contentdirectory/callback/Browse;->logger:Lorg/slf4j/Logger;

    .line 22
    .line 23
    const-string v0, "Creating browse action for object ID: {}"
    ...
    .line 42
    .line 43
    invoke-virtual {p3}, Lorg/jupnp/support/model/BrowseFlag;->toString()Ljava/lang/String;
    ...
    .line 80
    .line 81
    invoke-virtual {p0}, Lorg/jupnp/support/contentdirectory/callback/Browse;->getDefaultMaxResults()J
...
.method public receivedRaw(Lorg/jupnp/model/action/ActionInvocation;Lorg/jupnp/support/model/BrowseResult;)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lorg/jupnp/model/action/ActionInvocation<",
            "*>;",
            "Lorg/jupnp/support/model/BrowseResult;",
            ")Z"
        }
    .end annotation
...
.method public run()V
    ...
    .line 1
    sget-object v0, Lorg/jupnp/support/contentdirectory/callback/Browse$Status;->LOADING:Lorg/jupnp/support/contentdirectory/callback/Browse$Status;

    .line 2
    .line 3
    invoke-virtual {p0, v0}, Lorg/jupnp/support/contentdirectory/callback/Browse;->updateStatus(Lorg/jupnp/support/contentdirectory/callback/Browse$Status;)V
...
.method public success(Lorg/jupnp/model/action/ActionInvocation;)V
    ...
    .line 1
    iget-object v0, p0, Lorg/jupnp/support/contentdirectory/callback/Browse;->logger:Lorg/slf4j/Logger;
    ...
    .line 7
    .line 8
    new-instance v0, Lorg/jupnp/support/model/BrowseResult;
    ...
    .line 59
    .line 60
    invoke-direct {v0, v1, v2, v3, v4}, Lorg/jupnp/support/model/BrowseResult;-><init>(Ljava/lang/String;Lorg/jupnp/model/types/UnsignedIntegerFourBytes;Lorg/jupnp/model/types/UnsignedIntegerFourBytes;Lorg/jupnp/model/types/UnsignedIntegerFourBytes;)V

    .line 61
    .line 62
    .line 63
    invoke-virtual {p0, p1, v0}, Lorg/jupnp/support/contentdirectory/callback/Browse;->receivedRaw(Lorg/jupnp/model/action/ActionInvocation;Lorg/jupnp/support/model/BrowseResult;)Z
    ...
    .line 68
    .line 69
    invoke-virtual {v0}, Lorg/jupnp/support/model/BrowseResult;->getCountLong()J
    ...
    .line 78
    .line 79
    invoke-virtual {v0}, Lorg/jupnp/support/model/BrowseResult;->getResult()Ljava/lang/String;
    ...
    .line 102
    invoke-virtual {p0, p1, v0}, Lorg/jupnp/support/contentdirectory/callback/Browse;->received(Lorg/jupnp/model/action/ActionInvocation;Lorg/jupnp/support/model/DIDLContent;)V

    .line 103
    .line 104
    .line 105
    sget-object v0, Lorg/jupnp/support/contentdirectory/callback/Browse$Status;->OK:Lorg/jupnp/support/contentdirectory/callback/Browse$Status;
    ...
    .line 144
    .line 145
    sget-object p1, Lorg/jupnp/support/contentdirectory/callback/Browse$Status;->NO_CONTENT:Lorg/jupnp/support/contentdirectory/callback/Browse$Status;

    .line 146
    .line 147
    invoke-virtual {p0, p1}, Lorg/jupnp/support/contentdirectory/callback/Browse;->updateStatus(Lorg/jupnp/support/contentdirectory/callback/Browse$Status;)V
...
.method public abstract updateStatus(Lorg/jupnp/support/contentdirectory/callback/Browse$Status;)V
.end method
