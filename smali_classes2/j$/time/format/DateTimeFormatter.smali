...
.method static constructor <clinit>()V
    ...
    .line 2
    invoke-virtual {v0, v1, v3, v4, v2}, Lj$/time/format/v;->o(Lj$/time/temporal/p;IILj$/time/format/e0;)V
    ...
    .line 7
    invoke-virtual {v0, v9, v10}, Lj$/time/format/v;->r(Lj$/time/format/d0;Lj$/time/chrono/l;)Lj$/time/format/DateTimeFormatter;
    ...
    .line 12
    invoke-virtual {v11, v9, v10}, Lj$/time/format/v;->r(Lj$/time/format/d0;Lj$/time/chrono/l;)Lj$/time/format/DateTimeFormatter;
    ...
    .line 28
    invoke-virtual {v11, v9, v3}, Lj$/time/format/v;->r(Lj$/time/format/d0;Lj$/time/chrono/l;)Lj$/time/format/DateTimeFormatter;
    ...
    .line 33
    invoke-virtual {v7, v9, v3}, Lj$/time/format/v;->r(Lj$/time/format/d0;Lj$/time/chrono/l;)Lj$/time/format/DateTimeFormatter;
    ...
    .line 45
    invoke-virtual {v7, v9, v10}, Lj$/time/format/v;->r(Lj$/time/format/d0;Lj$/time/chrono/l;)Lj$/time/format/DateTimeFormatter;
    ...
    .line 52
    invoke-virtual {v4, v9, v10}, Lj$/time/format/v;->r(Lj$/time/format/d0;Lj$/time/chrono/l;)Lj$/time/format/DateTimeFormatter;

    move-result-object v4

    sput-object v4, Lj$/time/format/DateTimeFormatter;->h:Lj$/time/format/DateTimeFormatter;
    ...
    sget-object v5, Lj$/time/format/v;->h:Lj$/time/d;

    move-object/from16 v19, v14

    const-string v14, "ZoneRegionId()"

    invoke-direct {v4, v5, v14}, Lj$/time/format/t;-><init>(Lj$/time/d;Ljava/lang/String;)V
    ...
    .line 60
    invoke-virtual {v3, v9, v10}, Lj$/time/format/v;->r(Lj$/time/format/d0;Lj$/time/chrono/l;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-direct {v0, v5, v14}, Lj$/time/format/t;-><init>(Lj$/time/d;Ljava/lang/String;)V
    ...
    .line 82
    invoke-virtual {v0, v3, v4, v5, v2}, Lj$/time/format/v;->o(Lj$/time/temporal/p;IILj$/time/format/e0;)V
    ...
    .line 95
    invoke-virtual {v0, v9, v3}, Lj$/time/format/v;->r(Lj$/time/format/d0;Lj$/time/chrono/l;)Lj$/time/format/DateTimeFormatter;
    ...
    .line 135
    invoke-virtual {v3, v8, v4, v2, v0}, Lj$/time/format/v;->o(Lj$/time/temporal/p;IILj$/time/format/e0;)V
    ...
    .line 150
    invoke-virtual {v3, v0, v1}, Lj$/time/format/v;->r(Lj$/time/format/d0;Lj$/time/chrono/l;)Lj$/time/format/DateTimeFormatter;

    return-void
.end method

.method public constructor <init>(Lj$/time/format/d;Ljava/util/Locale;Lj$/time/format/b0;Lj$/time/format/d0;Lj$/time/chrono/l;Lj$/time/ZoneId;)V
    .locals 1
...
.method public static ofLocalizedDate(Lj$/time/format/FormatStyle;)Lj$/time/format/DateTimeFormatter;
    ...
    .line 18
    .line 19
    invoke-virtual {v0, p0, v1}, Lj$/time/format/v;->r(Lj$/time/format/d0;Lj$/time/chrono/l;)Lj$/time/format/DateTimeFormatter;
...
.method public static ofPattern(Ljava/lang/String;)Lj$/time/format/DateTimeFormatter;
    ...
    .line 16
    invoke-virtual {v0, p0, v1, v2}, Lj$/time/format/v;->s(Ljava/util/Locale;Lj$/time/format/d0;Lj$/time/chrono/l;)Lj$/time/format/DateTimeFormatter;
...
.method public static ofPattern(Ljava/lang/String;Ljava/util/Locale;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v0, p1, p0, v1}, Lj$/time/format/v;->s(Ljava/util/Locale;Lj$/time/format/d0;Lj$/time/chrono/l;)Lj$/time/format/DateTimeFormatter;
...
# virtual methods
.method public final a(Ljava/lang/CharSequence;Lj$/time/d;)Ljava/lang/Object;
    .locals 4
    ...
    .line 10
    invoke-virtual {p0, p2}, Lj$/time/format/c0;->b(Lj$/time/d;)Ljava/lang/Object;
...
.method public final b(Ljava/lang/CharSequence;)Lj$/time/format/c0;
    ...
    invoke-virtual {v6, v4, v1, v5}, Lj$/time/format/d;->C(Lj$/time/format/w;Ljava/lang/CharSequence;I)I
    ...
    .line 9
    :cond_1
    invoke-virtual {v4}, Lj$/time/format/w;->c()Lj$/time/format/c0;
    ...
    iput-object v1, v8, Lj$/time/format/c0;->c:Lj$/time/chrono/l;
    ...
    .line 15
    invoke-virtual {v8}, Lj$/time/format/c0;->o()V

    .line 16
    iget-object v0, v8, Lj$/time/format/c0;->c:Lj$/time/chrono/l;

    iget-object v1, v8, Lj$/time/format/c0;->a:Ljava/util/Map;

    iget-object v2, v8, Lj$/time/format/c0;->e:Lj$/time/format/d0;

    invoke-interface {v0, v1, v2}, Lj$/time/chrono/l;->U(Ljava/util/Map;Lj$/time/format/d0;)Lj$/time/chrono/b;

    move-result-object v0

    invoke-virtual {v8, v0}, Lj$/time/format/c0;->u(Lj$/time/chrono/b;)V

    .line 17
    invoke-virtual {v8}, Lj$/time/format/c0;->s()V
    ...
    invoke-interface {v2, v4, v8, v5}, Lj$/time/temporal/p;->H(Ljava/util/Map;Lj$/time/format/c0;Lj$/time/format/d0;)Lj$/time/temporal/TemporalAccessor;
    ...
    .line 27
    :goto_3
    invoke-interface {v4}, Lj$/time/chrono/ChronoZonedDateTime;->y()Lj$/time/chrono/e;
    ...
    :cond_6
    :goto_4
    instance-of v0, v4, Lj$/time/chrono/e;
    ...
    .line 33
    invoke-interface {v4}, Lj$/time/chrono/e;->toLocalTime()Lj$/time/LocalTime;

    move-result-object v0

    sget-object v1, Lj$/time/Period;->d:Lj$/time/Period;

    invoke-virtual {v8, v0, v1}, Lj$/time/format/c0;->t(Lj$/time/LocalTime;Lj$/time/Period;)V

    .line 34
    invoke-interface {v4}, Lj$/time/chrono/e;->m()Lj$/time/chrono/b;
    ...
    invoke-virtual {v8, v4}, Lj$/time/format/c0;->u(Lj$/time/chrono/b;)V
    ...
    invoke-virtual {v8, v4, v0}, Lj$/time/format/c0;->t(Lj$/time/LocalTime;Lj$/time/Period;)V
    ...
    sget-object v11, Lj$/time/temporal/a;->MICRO_OF_SECOND:Lj$/time/temporal/a;
    ...
    invoke-virtual {v8, v7, v11, v0}, Lj$/time/format/c0;->v(Lj$/time/temporal/p;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    invoke-virtual/range {v8 .. v16}, Lj$/time/format/c0;->q(JJJJ)V
    ...
    invoke-virtual {v2}, Lj$/time/temporal/a;->c0()Z
    ...
    invoke-virtual {v2, v9, v10}, Lj$/time/temporal/a;->b0(J)V
    ...
    :cond_19
    :goto_f
    iget-object v0, v8, Lj$/time/format/c0;->f:Lj$/time/chrono/b;

    if-eqz v0, :cond_1a

    .line 77
    invoke-virtual {v8, v0}, Lj$/time/format/c0;->n(Lj$/time/temporal/TemporalAccessor;)V
    ...
    invoke-interface {v0, v1}, Lj$/time/chrono/b;->M(Lj$/time/LocalTime;)Lj$/time/chrono/e;
    ...
    iget-object v0, v8, Lj$/time/format/c0;->h:Lj$/time/Period;
    ...
    iget-object v2, v8, Lj$/time/format/c0;->h:Lj$/time/Period;

    invoke-interface {v0, v2}, Lj$/time/chrono/b;->T(Lj$/time/temporal/o;)Lj$/time/chrono/b;

    move-result-object v0

    iput-object v0, v8, Lj$/time/format/c0;->f:Lj$/time/chrono/b;

    .line 85
    iput-object v1, v8, Lj$/time/format/c0;->h:Lj$/time/Period;
    ...
    .line 102
    iget-object v1, v8, Lj$/time/format/c0;->f:Lj$/time/chrono/b;

    iget-object v2, v8, Lj$/time/format/c0;->g:Lj$/time/LocalTime;

    invoke-interface {v1, v2}, Lj$/time/chrono/b;->M(Lj$/time/LocalTime;)Lj$/time/chrono/e;
    ...
    invoke-interface {v0}, Lj$/time/chrono/ChronoZonedDateTime;->a0()J
...
.method public format(Lj$/time/temporal/TemporalAccessor;)Ljava/lang/String;
    ...
    .line 19
    .line 20
    invoke-virtual {v1, v2, v0}, Lj$/time/format/d;->q(Lj$/time/format/x;Ljava/lang/StringBuilder;)Z
    :try_end_0
